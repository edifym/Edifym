...
class RunSingleSimulationTask(ITask):
    ...
    def execute(self):
        ...
        try:
            ...
            CommandHelper.run_command([self.main_config.zstd, '-1', '--rm', '-f', f'stats.txt', '-o', f'{self.main_config.stats_dir}/run_{self.run_id}/stats.txt.zst'], {}, self.main_config.show_command_output, self.main_config.show_command_error, f'{self.main_config.out_dir}/run_{self.run_id}/m5out')
